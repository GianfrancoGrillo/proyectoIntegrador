...
export default class DetailMovies extends Component {
    ...
    componentDidMount() {
     ...
     handleButton(){
        this.setState({boton: !this.state.boton}, ()=>{this.props.favoritos(this.props.peliculas)})
    } 
                ...
                <section>
                    ...
                    <section className='cardContainer'>
                        <article className='item-card-detail2'>
                            <img src={`${img}${this.state.pelicula.poster_path}`} alt="imagen" />
                        </article>
                        <article className='item-card-detail'>
                            ...
                            {<p>Género: {this.state.pelicula.genre}</p>}
